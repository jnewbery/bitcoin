...
class RESTTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.sync_all()
        self.nodes[1].generatetoaddress(100, "2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ")  # Random address so node1's balance doesn't increase
        self.sync_all()
        ...
        self.sync_all()
        self.nodes[1].generatetoaddress(1, "2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ")  # Random address so node1's balance doesn't increase
        self.sync_all()
        ...
        n = [vout['n'] for vout in json_obj['vout'] if vout['value'] == Decimal('0.1')][0]

        self.log.info("Query an unspent TXO using the /getutxos URI")

        json_obj = self.test_rest_request("/getutxos/{}-{}".format(txid, str(n)))
        ...
        json_obj = self.test_rest_request("/getutxos/{}-0".format(vintx))
        ...
        json_obj = self.test_rest_request("/getutxos/{}-{}/{}-0".format(txid, str(n), vintx))
        ...
        txs = []
        txs.append(self.nodes[0].sendtoaddress("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ", 11))
        txs.append(self.nodes[0].sendtoaddress("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ", 11))
        txs.append(self.nodes[0].sendtoaddress("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ", 11))
        self.sync_all()
        ...
        for tx in [tx for tx in json_obj['tx'] if 'coinbase' not in tx['vin'][0]]:  # exclude coinbase
