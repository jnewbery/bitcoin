...
BOOST_AUTO_TEST_CASE(outbound_slow_chain_eviction)
{
    ...
    auto connman = MakeUnique<CConnman>(0x1337, 0x1337, *m_node.addrman);
    auto peerLogic = MakeUnique<PeerManager>(chainparams, *connman, *m_node.addrman, nullptr,
...
{
    const CChainParams& chainparams = Params();
    auto connman = MakeUnique<CConnmanTest>(0x1337, 0x1337, *m_node.addrman);
    auto peerLogic = MakeUnique<PeerManager>(chainparams, *connman, *m_node.addrman, nullptr,
                                             *m_node.scheduler, *m_node.chainman, *m_node.mempool);
...
BOOST_AUTO_TEST_CASE(peer_discouragement)
{
    ...
    auto connman = MakeUnique<CConnman>(0x1337, 0x1337, *m_node.addrman);
    auto peerLogic = MakeUnique<PeerManager>(chainparams, *connman, *m_node.addrman, banman.get(),
                                             *m_node.scheduler, *m_node.chainman, *m_node.mempool);
