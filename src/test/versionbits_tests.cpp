...
static void check_computeblockversion(const Consensus::Params& params, Consensus::DeploymentPos dep)
{
    ...
    BOOST_CHECK_EQUAL(VersionBits::ComputeBlockVersion(nullptr, params), VERSIONBITS_TOP_BITS);
    ...
    const uint32_t bitmask{VersionBits::Mask(params, dep)};
    ...
    if (nTime == 0) {
        ...
        BOOST_CHECK_EQUAL(VersionBits::ComputeBlockVersion(lastBlock, params) & (1<<bit), 0);
        lastBlock = firstChain.Mine(params.nMinerConfirmationWindow, nTime, VERSIONBITS_LAST_OLD_BLOCK_VERSION).Tip();
        BOOST_CHECK((VersionBits::ComputeBlockVersion(lastBlock, params) & (1<<bit)) != 0);
    ...
    BOOST_CHECK_EQUAL(VersionBits::ComputeBlockVersion(lastBlock, params) & VERSIONBITS_TOP_MASK, VERSIONBITS_TOP_BITS);
...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_name : {CBaseChainParams::MAIN, CBaseChainParams::TESTNET, CBaseChainParams::SIGNET, CBaseChainParams::REGTEST}) {
        ...
        for (int i = 0; i < (int)Consensus::MAX_VERSION_BITS_DEPLOYMENTS; ++i) {
            ...
            // times are picked.
            const uint32_t dep_mask{VersionBits::Mask(chainParams->GetConsensus(), dep)};
