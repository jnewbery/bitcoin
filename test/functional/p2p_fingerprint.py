...
class P2PFingerprintTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        block_hashes = self.nodes[0].generatetoaddress(10, self.nodes[0].deterministic_address.address)
        ...
        tip = self.nodes[0].generatetoaddress(1, self.nodes[0].deterministic_address.address)[0]
