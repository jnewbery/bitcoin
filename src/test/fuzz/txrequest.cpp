...
class Tester
{
    ...
    //! The txidnums returned by the last GetRequestable, which ForgetTx or RequestedTx haven't been called on yet.
...
public:
    ...
    void ForgetTx(int txhash, bool is_wtxid)
    {
        ...
        // Call TxRequestTracker's implementation.
        m_tracker.ForgetTx(GenTxid{is_wtxid, TXHASHES[txhash]});
    }
...
void test_one_input(const std::vector<uint8_t>& buffer)
{
    ...
    while (it != buffer.end()) {
        ...
        case 4: // No longer need tx
            ...
            tester.ForgetTx(txidnum % MAX_TXHASHES, (txidnum / MAX_TXHASHES) & 1);
            break;
