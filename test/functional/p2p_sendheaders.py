...
class SendHeadersTest(BitcoinTestFramework):
    ...
    def mine_blocks(self, count):
        ...
        self.nodes[0].generatetoaddress(count, self.nodes[0].deterministic_address.address)
    ...
    def mine_reorg(self, length):
        ...
        self.nodes[0].generatetoaddress(length, self.nodes[0].deterministic_address.address)
        ...
        all_hashes = self.nodes[1].generatetoaddress(length + 1, self.nodes[1].deterministic_address.address)  # Must be longer than the orig chain
        sync_blocks(self.nodes, wait=0.1)
    ...
    def test_null_locators(self, test_node, inv_node):
        tip = self.nodes[0].getblockheader(self.nodes[0].generatetoaddress(1, self.nodes[0].deterministic_address.address)[0])
