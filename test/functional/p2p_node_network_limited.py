...
class NodeNetworkLimitedTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        blocks = self.nodes[1].generatetoaddress(292, self.nodes[1].deterministic_address.address)
        ...
        self.nodes[0].generatetoaddress(10, self.nodes[0].deterministic_address.address)
