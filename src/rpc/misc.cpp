...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "  \"script\" : \"type\"       (string, optional) DEPRECATED. The type of the redeemscript. Possible types: nonstandard, pubkey, pubkeyhash, scripthash, multisig, nulldata, witness_v0_keyhash, witness_v0_scripthash\n"
            ...
            "  \"pubkey\" : \"publickeyhex\",    (string, optional) DEPRECATED. The hex value of the raw public key\n"
            "  \"iscompressed\" : true|false,  (boolean, optional) DEPRECATED. If the address is compressed\n"
