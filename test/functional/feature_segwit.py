...
class SegWitTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-walletprematurewitness", "-rpcserialversion=0", "-segwitheight=432", "-addresstype=legacy", "-deprecatedrpc=addwitnessaddress"],
                           ["-blockversion=4", "-promiscuousmempoolflags=517", "-prematurewitness", "-walletprematurewitness", "-rpcserialversion=1", "-segwitheight=432", "-addresstype=legacy", "-deprecatedrpc=addwitnessaddress"],
                           ["-blockversion=536870915", "-promiscuousmempoolflags=517", "-prematurewitness", "-walletprematurewitness", "-segwitheight=432", "-addresstype=legacy", "-deprecatedrpc=addwitnessaddress"]]
